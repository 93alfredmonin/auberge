 ...
 */
	...
	if ( ! is_active_sidebar( 'cofe-sidebar' ) ) {
		return;
	}
 ...
 */
	...
	<aside id="secondary" class="widget-area sidebar" aria-labelledby="sidebar-label"<?php echo wm_schema_org( 'WPSideBar' ); ?>>
		...
		<h2 class="screen-reader-text" id="sidebar-label"><?php echo esc_attr_x( 'cofe-sidebar', 'Sidebar aria label', 'auberge' ); ?></h2>
